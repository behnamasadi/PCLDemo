...
int main (int argc, char** argv)
{
  ...
  //models.size () * models[0].second.size ()] total number of element in the matrix
  //models.size () total number of rows
  //models[0].second.size () total number of columns
  //total number of element in the matrix, total number of rows, total number of columns
